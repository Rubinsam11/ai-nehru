...
function App() {
  ...
  return (
 <div className={` h-[800px] sm:h-[400px] md:h-[500px] lg:h-[600px] xl:h-[700px]  flex flex-col items-center justify-center transition-colors duration-300 ${isDarkMode ? 'bg-black' : 'bg-white'}`}
        style={{
